...
public static class ServiceCollectionExtensions
{
    extension(IHttpClientBuilder builder)
    {
        ...
        public IHttpClientBuilder AddHttpSimpleRetry(bool bufferRequestContent = false, bool cloneRequest = false)
            => builder.AddHttpSimpleRetry(static _ => { }, bufferRequestContent, cloneRequest);
        ...
        public IHttpClientBuilder AddHttpSimpleRetry(Action<RetryPolicyOptions> configure, bool bufferRequestContent = false, bool cloneRequest = false)
        {
            ArgumentNullException.ThrowIfNull(builder);
            ArgumentNullException.ThrowIfNull(configure);

            return builder.AddHttpSimpleRetry((_, options) => configure(options), bufferRequestContent, cloneRequest);
        }
        ...
        /// </para>
        /// </remarks>
        public IHttpClientBuilder AddHttpSimpleRetry(Action<IServiceProvider, RetryPolicyOptions> configure, bool bufferRequestContent = false, bool cloneRequest = false)
        {
            ArgumentNullException.ThrowIfNull(builder);
            ArgumentNullException.ThrowIfNull(configure);
            ...
            builder.AddHttpMessageHandler(services => new HttpRetryDelegatingHandler(services.GetRequiredKeyedService<IRetryExecutor>(builder.Name),
                bufferRequestContent, cloneRequest));
